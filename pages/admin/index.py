...
class AdminMain:
    def __init__(self):
        ...
        self.image8 = Image.open(
            os.path.join(os.path.dirname(__file__), '../../public/images/sales_button.png'))
        self.image8 = self.image8.resize((200, 200), Image.ANTIALIAS)
        self.image8 = ImageTk.PhotoImage(self.image8)
        Label(self.window, image=self.image8, font=('Fredoka', 20), fg="white", bg="#35374f").grid(row=3, column=3,
                                                                                                   columnspan=3,
                                                                                                   sticky="WE")
